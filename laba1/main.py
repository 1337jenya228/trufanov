...
print('Для подсчета мощности пароля будет использоваться латинский алфавит')
...
password_time_seconds = (password_power/speed_password) + (password_power/count_failed)*pause_time
...
print('Подбор пароля займет ', years, ' лет ', mounths, ' месяцев ', days, ' дней ', hours, ' часов ', minutes, ' минут ', seconds, 'секунд')